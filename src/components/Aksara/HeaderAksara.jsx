...
const HeaderAksara = ({ slug, handleTutorial }) => {
  return (
    <header className="w-full max-w-6xl flex flex-col md:flex-row items-center justify-between gap-4 mb-8">
      ...
      <button
        ...
        className="flex items-center gap-2 py-2 px-5 w-full md:w-auto justify-center rounded-lg bg-yellow-500/10 hover:bg-yellow-500/20 text-yellow-500 border border-yellow-500/30 transition-all"
      >
        <PencilRuler size={18} />
